...
public class ZebraRfid extends BroadcastReceiver implements ZebraDevice, RfidEventsListener {
    ...
    public static boolean isSupported(Context context) {
        ...
        try {
            ...
            Log.d(ZebraRfidLib.getTagName(context), "Reader does not support RFID");
        }
        return false;
    }
    ...
    private synchronized void ConfigureReader() {
        if (isReaderConnected()) {
            ...
            try {
                Log.d("RFIDPlugin", "Configuration section begins....");
                Log.d(ZebraRfidLib.getTagName(context), "ConfigureReader()");

                // receive events from reader
                setEvents();
                Log.d("RFIDPlugin", "Set event completed and the mode is "+mode.toString());
                // set mixed mode as default
                setMode(mode);
                Log.d("RFIDPlugin", "Set mode is completed");
                // set start and stop triggers
                setTriggers(START_TRIGGER_TYPE.START_TRIGGER_TYPE_IMMEDIATE, STOP_TRIGGER_TYPE.STOP_TRIGGER_TYPE_IMMEDIATE);
                Log.d("RFIDPlugin", "Set trigger option completed");
                // power levels are index based so maximum power supported get the last one
                int powerLevel =  reader.ReaderCapabilities.getTransmitPowerLevelValues().length - 1;
                int maximumPower = reader.ReaderCapabilities.getTransmitPowerLevelValues().length;
                setPowerLevel(powerLevel);
                Log.d("RFIDPlugin", "Set power level completed and the power level is "+String.valueOf(powerLevel)+" maximum power is "+String.valueOf(maximumPower));
                ...
                Log.d("RFIDPlugin", "Exception in configuration section and the message is "+e.toString());
                Log.e(ZebraRfidLib.getTagName(context), "Error configuring reader. Error: " + e.toString());
            }
        }
    }
    ...
    public void createProfile(){
        ...
        String packageName = ZebraRfidLib.getPackageName(context);
        String profileName = ZebraRfidLib.getProfileName(context);
        String actionName  = ZebraRfidLib.getActionName(context);
        Log.i(ZebraRfidLib.getTagName(context), "Creating Datawedge profile " + profileName + " for package " + packageName + " with Intent action " + getActionName(context));
    ...
    private String getActionName(Context context) {
        return ZebraRfidLib.getPackageName(context) + ".ACTION";
    }

    private String getServiceActionName(Context context) {
        return ZebraRfidLib.getPackageName(context) + "service.ACTION";
    }
    ...
    private void setRegulatoryConfig() {
        ...
        try {
            if (reader != null) {
                Log.e(ZebraRfidLib.getTagName(context),"Setting region");
            ...
            Log.e(ZebraRfidLib.getTagName(context), "Error setting region. Error: " + e.getMessage());
        }
    }
    ...
    public void setPowerLevel(int level) {
        ...
        {
            if (reader != null) {
                Log.d("RFIDPlugin", "Set power level evoked and the power level is "+String.valueOf(level));
                Antennas.AntennaRfConfig config = reader.Config.Antennas.getAntennaRfConfig(1);
                int maximumPower = reader.ReaderCapabilities.getTransmitPowerLevelValues().length - 1;
                if(level > maximumPower) {
                    config.setTransmitPowerIndex(maximumPower);
                }{
                ...
                Log.d("RFIDPlugin", "Set power level completed and the power level is "+String.valueOf(level));
            }
        }
        catch (Exception e) {
            Log.d("RFIDPlugin", "Set power level exception occurred and the message is "+e.toString());
            Log.e(ZebraRfidLib.getTagName(context), "Error setting power level. Error: " + e.toString());
        }
    }
    ...
    public void setEvents() {
        try {
            ...
            Log.e(ZebraRfidLib.getTagName(context), "Error in setEvents(). Error: " + e.toString());
        }
    }
    ...
    private void setMode(ENUM_TRIGGER_MODE mode) {
        try {
            ...
            Log.e(ZebraRfidLib.getTagName(context),e.getMessage());
        }
    }
...
//                setMode(ENUM_TRIGGER_MODE.BARCODE_MODE);
            ...
            Log.d("RFIDPlugin", "Set mode exception occurred and the message is "+e.toString());
        }
    }
    ...
    public void setTriggers(START_TRIGGER_TYPE start, STOP_TRIGGER_TYPE stop) {
        try {
            ...
            Log.e(ZebraRfidLib.getTagName(context)," setTriggers exception: "+e.toString());
        }
    }
    ...
    public void setAntennaConfig() {
        try {
            ...
            Log.e(ZebraRfidLib.getTagName(context)," Set antenna config exception: "+e.toString());
        }
    }
    ...
    public void connect() {
        ...
        try
        {
            Log.i(ZebraRfidLib.getTagName(context),"Connecting to RFID reader");
            ...
            connectionTask = new AsyncTasks() {
                ...
                public void doInBackground() {
                    Log.d("RFIDPlugin", "Received method------------------123");
                    try {
                        if (reader == null) {
                            Readers readers = new Readers(context,ENUM_TRANSPORT.ALL);
                            ...
                            if (rfidReaders.size() > 0) {
                                ...
                                Log.e(ZebraRfidLib.getTagName(context),"No connectable rfid devices found");
                            }
                        }

                        if (reader != null) {
                            Log.d("RFIDPlugin", "Received method------------------1234");
                            reader.connect();
                            ConfigureReader();
                        }
                    }
                    ...
                    {
                        Log.d("RFIDPlugin", "Received method------------------12345");
                        Log.d(ZebraRfidLib.getTagName(context), e.toString());
                    }
                }
        ...
        {
            Log.e(ZebraRfidLib.getTagName(context),"Error connecting to RFID reader. Error is " + e.toString());
        }
    }
    ...
    private void connectDatawedge() {
        ...
        try
        {
            ...
            filter.addAction(ZebraRfidLib.getActionName(context));
            ...
            Log.e(ZebraRfidLib.getTagName(context),"Error connecting to datawedge. Error is " + e.toString());
        }
    }
    ...
    private void disconnectDatawedge() {
        ...
        try
        {
            ...
            isDWRegistered = false;
            Log.e(ZebraRfidLib.getTagName(context),"Error disconnecting datawedge. Error is " + e.toString());
        }
    }
    ...
    public void disconnect() {
        try {
            Log.i(ZebraRfidLib.getTagName(context),"Disconnecting from RFID reader");
            ...
            Log.e(ZebraRfidLib.getTagName(context),"Error disconnecting from RFID reader. Error is " + e.toString());
        }
    }
    ...
    private boolean isReaderConnected() {
        if (reader != null && reader.isConnected())
            ...
            if (reader == null)
                 Log.d(ZebraRfidLib.getTagName(context), "Reader is null");
            else Log.d(ZebraRfidLib.getTagName(context), "Reader is not connected");
            return false;
        }
    }
    ...
    public void eventReadNotify(RfidReadEvents event) {
        try {
            ...
            Log.e(ZebraRfidLib.getTagName(context), "Error reading tag data. Error is " + e.toString());
        }
    }
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (actionSource.equals(actionTarget)) {
            try {
                ...
                // notify listener
                Log.d(ZebraRfidLib.getTagName(context), Events.readBarcode + ": " + tag);

                // only send if mixed or barcode mode
                if (mode == Modes.mixed || mode == Modes.barcode) sendEvent(Events.readBarcode, tag);
            }
            catch(Exception e) {
                Log.e(ZebraRfidLib.getTagName(context), "Error deserializing json object" + e.getMessage());
    ...
    public void eventStatusNotify(RfidStatusEvents event) {
        ...
        Log.d(ZebraRfidLib.getTagName(context), "eventStatusNotify()");
        ...
        if (eventType == STATUS_EVENT_TYPE.HANDHELD_TRIGGER_EVENT) {
            ...
            {
                Log.d(ZebraRfidLib.getTagName(context), "TRIGGER DOWN");
            ...
            // trigger up?
                ...
                Log.d(ZebraRfidLib.getTagName(context), "TRIGGER UP");
    ...
    synchronized void syncTags() {
        try
        {
            if (tags.size() > 0) {
                ...
                // notify listener
                if (mode == Modes.rfid || mode == Modes.mixed) sendEvent(Events.reading,hashMap);
            }
        }
        catch (Exception e) {
            Log.e(ZebraRfidLib.getTagName(context), "Error in reportTags()");
        }
    }
    ...
    synchronized void startScanning() {
        ...
        try
        {
            ...
            if (reader != null)
            {
                ...
                {
                    Log.d(ZebraRfidLib.getTagName(context), "START SCANNNING");
                ...
                {
                    Log.d(ZebraRfidLib.getTagName(context), "START READING");
        ...
        {
            Log.e(ZebraRfidLib.getTagName(context), "Error in startInventory()");
            stopScanning();
        }
    }
    ...
    synchronized void stopScanning() {
        ...
        try
        {
            if (reader != null)
            {
                if (mode == Modes.mixed || mode == Modes.rfid)
                {
                    Log.d(ZebraRfidLib.getTagName(context), "STOP SCANNING. Found " + tags.size() + " tags");
                ...
                if (mode == Modes.mixed || mode == Modes.barcode)
                {
                    Log.d(ZebraRfidLib.getTagName(context), "STOP READING");
            ...
            Log.e(ZebraRfidLib.getTagName(context), "Error in stopInventory()");
        }
    }
    ...
    synchronized void startTracking(ArrayList<String> tags) {
        ...
        try
        {
            ...
            if (reader != null) {
                Log.d(ZebraRfidLib.getTagName(context), "STARTING TRACKING");
        ...
        {
            Log.e(ZebraRfidLib.getTagName(context), "Error in startTracking()");
            stopTracking();
        }
    }
    ...
    synchronized void stopTracking() {
        ...
        {
            if (reader != null) {
                Log.d(ZebraRfidLib.getTagName(context), "STOPPING TRACKING. Found " + tags.size() + " tags");
            ...
            Log.e(ZebraRfidLib.getTagName(context), "Error in stopTracking()");
        }
    }

    // configuration
    private void setAntennaPower(int power) {
        Log.d(ZebraRfidLib.getTagName(context), "setAntennaPower " + power);
        try {
    ...
    private void setSingulation(SESSION session, INVENTORY_STATE state) {
        Log.d(ZebraRfidLib.getTagName(context), "setSingulation " + session);
        try {
            // Set the singulation control
            Antennas.SingulationControl s1_singulationControl = reader.Config.Antennas.getSingulationControl(1);
    ...
    private void setDPO(boolean bEnable) {
        Log.d(ZebraRfidLib.getTagName(context), "setDPO " + bEnable);
        try {
            // control the DPO
    ...
    public void write(String epc, String newEpc, String password, String newPassword, String data) {
        ...
        if (epc != newEpc && newEpc != null && newEpc.trim().length() > 0) {
            ...
            if (exception != null) {
                ok = false;
                Log.e(ZebraRfidLib.getTagName(context), "Error writing tag epc: " + exception.getMessage());
        ...
        if (data != null && data.length() > 0) {
            ...
            if (exception != null) {
                ok = false;
                Log.e(ZebraRfidLib.getTagName(context), "Error writing tag data: " + exception.getMessage());
        ...
        if (password != newPassword && newPassword != null && newPassword.trim().length() > 0) {
            ...
            if (exception != null) {
                ok = false;
                Log.e(ZebraRfidLib.getTagName(context), "Error writing tag password: " + exception.getMessage());
    ...
    private Exception writeTag(String sourceEPC, String Password, MEMORY_BANK memory_bank, String targetData, int offset) {
        ...
        try {
            Log.i(ZebraRfidLib.getTagName(context), "Writeing RFID tag");
            ...
            Log.e(ZebraRfidLib.getTagName(context), "Error during writeTag(). Error: " + e.getMessage());
            return e;
        }
    }
    ...
    private void sendEvent(final ZebraDevice.Events event, final HashMap map) {
        ...
        if (sink == null) {
            Log.e(ZebraRfidLib.getTagName(context), "Can't send notification to flutter. Sink is null");
            return;
        }
        ...
        handler.post(() -> {
            ...
            {
                Log.e(ZebraRfidLib.getTagName(context), "Error sending notification to flutter. Error: " + e.getMessage());
            }
        });
    }
