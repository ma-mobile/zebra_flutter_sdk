...
public class ZebraDataWedge extends BroadcastReceiver implements ZebraDevice {
    ...
    public static boolean isSupported(Context context) {
        try {
            ...
            Log.d(ZebraRfidLib.getTagName(context), "Reader does not support Data Wedge");
        }
        return false;
    }
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        String actionTarget = ZebraRfidLib.getActionName(context);
        if (actionSource.equals(actionTarget)) {
            try {
                ...
                if (barcode.equals(barcodeLast) && Math.abs(seen - seenLast) < 1000) {
                    Log.e(ZebraRfidLib.getTagName(context), "Duplicate barcode read within 1 second. Skipping.");
                    return;
                }
                barcodeLast = barcode;
                seenLast = seen;
    ...
    public static void send(Context context, String extraKey, Bundle extraValue) {
        ...
        {
            Log.e(ZebraRfidLib.getTagName(context), "Error sending command to device" + e.getMessage());
        }
    }
    ...
    public void connect() {
        ...
        try {
            ...
            Log.e(ZebraRfidLib.getTagName(context), "Error connecting to device" + e.getMessage());
    ...
    public void disconnect() {
        ...
        try {
            ...
            Log.e(ZebraRfidLib.getTagName(context), "Error disconnecting from device" + e.getMessage());
    ...
    public void dispose() {
        ...
        {
            Log.e(ZebraRfidLib.getTagName(context), "Error during dispose()." + e.getMessage());
        }
    }
    ...
    public void setPowerLevel(int level) {
        Exception exception = new Exception("Not implemented");
        sendEvent(Events.error, ZebraDevice.toError("Error calling level()", exception));
        return;
    }
    ...
    private void createProfile() {
        ...
        try {
            ...
            Log.i(ZebraRfidLib.getTagName(context), "Creating Datawedge profile " + profileName + " for package " + packageName + " with Intent action " + actionName);
            ...
            Log.e(ZebraRfidLib.getTagName(context), "Error creating profile" + e.getMessage());
        }
    }
